...
public class Base64
{
    ...
    /**
     * encode the input data producing a com.okycz.panasonic.base 64 encoded byte array.
     *
     * @return a byte array containing the com.okycz.panasonic.base 64 encoded data.
     */
    ...
    /**
     * decode the com.okycz.panasonic.base 64 encoded input data. It is assumed the input data is valid.
     *
    ...
    /**
     * decode the com.okycz.panasonic.base 64 encoded String data - whitespace will be ignored.
     *
     * @return a byte array representing the decoded data.
     */
    ...
    /**
     * decode the com.okycz.panasonic.base 64 encoded String data writing it to the given output stream,
